  ...
  <div class="row">
    <div class="wpm-col-6">
      <table class="table table-responsive wpm_6310_admin_table">
        ...
        <td>
          <input type="text" min="0" name="read_more_text" value="<?php echo (isset($allSlider[312]) && $allSlider[312]) ? $allSlider[312] : 'Read more' ?>" class="wpm-form-input" step="1" id="read_more_text" />
        </td>
      </tr>
      <tr  class="read_more_act_field">
