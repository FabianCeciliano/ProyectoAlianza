...
function wpm_6310_team_showcase_supreme_install()
{
	...
	if (!($memberData)) {
		...
		('Adam Smith', 'CEO', '2', '', '0', '{$details}', 'top', '{$arr[0]}', '{$arr_hover[0]}', '1,37,24', 'https://www.linkedin.com||||admin@gmail.com||||+123456789', 'c-1588100157 {$category1}', '{$contact}', 'HTML||||92####||||####CSS||||90'),
		('George Michel', 'Sales Agent', '2', '', '0', '{$details}', 'top', '{$arr[1]}', '{$arr_hover[1]}', '2,37,38', 'https://www.facebook.com||||admin@gmail.com||||+123456789', 'c-1588100157 {$category2}', '{$contact}', 'PHP||||85####||||####HTML||||90'),
		('Margaret Thatcher', 'Web Developer', '2', '', '0', '{$details}', 'top', '{$arr[2]}', '{$arr_hover[2]}', '2,1,24', 'https://www.facebook.com||||https://www.linkedin.com||||+123456789', 'c-1588100157 {$category3}', '{$contact}', 'PHP||||85####||||####Laravel||||100'),
		('Aaron Hernandez', 'Web Developer', '2', '', '0', '{$details}', 'top', '{$arr[3]}', '{$arr_hover[3]}', '2,1,24', 'https://www.facebook.com||||https://www.linkedin.com||||+123456789', 'c-1588100157 {$category3}', '{$contact}', 'HTML||||85####||||####jQuery||||90'),
		('Lisa Haydon', 'Sales Agent', '2', '', '0', '{$details}', 'top', '{$arr[4]}', '{$arr_hover[4]}', '27,1,25', 'https://www.facebook.com||||admin@gmail.com||||+123456789', 'c-1588100157 {$category4}', '{$contact}', 'HTML||||92####||||####CSS||||90')";
